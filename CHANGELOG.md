...
* **New Brand Scenarios**: Added full-width layouts for PayPal, Amazon, Netflix, Spotify, Google Drive, and Instagram.

### Changed
* Redesigned main menu into a UIverse cyber dashboard with level cards.
* Replaced UI state toggles with native HTML5 `hidden` attributes for rock-solid stability.
